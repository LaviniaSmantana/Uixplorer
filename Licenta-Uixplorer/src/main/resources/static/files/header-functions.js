...
let friendsMenuWrap = document.getElementById('friendsMenuWrap');

function toggleMenu() {
    if (friendsMenuWrap.classList.contains("open-friends-menu")) {
        closeFriendsMenu();
    }
...
function toggleFriendsMenu() {
    ...
    friendsMenuWrap.classList.toggle("open-friends-menu");
}

function closeFriendsMenu() {
    friendsMenuWrap.classList.remove("open-friends-menu");
}

function closeAllMenus(event) {
    if (!subMenu.contains(event.target) && !friendsMenuWrap.contains(event.target) &&
        !event.target.classList.contains('header-avatar') &&
        !event.target.classList.contains('fa-user-group')) {
        closeMenu();
        closeFriendsMenu();
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Adăugăm evenimentul de clic pe document pentru a închide meniurile când se face clic oriunde altundeva
